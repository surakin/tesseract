...
struct ShellClearCacheWithAccountManager { tesseract::AccountManager am_; };

struct ShellClearCacheTestShell : ShellClearCacheWithAccountManager, ShellBase
{
    ShellClearCacheTestShell() : ShellBase(am_) {}
