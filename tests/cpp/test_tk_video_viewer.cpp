...
TEST_CASE("VideoViewerOverlay pointer-down outside fires on_close via pointer-up",
          "[tk][videoviewer]") {
    Stage st;
    VideoViewerOverlay overlay;
    overlay.open("mxc://example.org/v", "", "video/mp4", 0u, 640, 360);
...
TEST_CASE("VideoViewerOverlay pointer-down on play button does not fire on_close",
          "[tk][videoviewer]") {
    Stage st;
    VideoViewerOverlay overlay;
    overlay.open("mxc://example.org/v", "", "video/mp4", 0u, 640, 360);
...
TEST_CASE("MessageListView Kind::Video rows paint with area taller than text rows",
