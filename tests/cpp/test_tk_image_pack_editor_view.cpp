...
// ── Geometry mirrors ImagePackEditorView/ImagePackSectionList's private
         ...
         "[image_pack][view]")
{
    ...
    // Well above the list (over the new-pack-name row) — not in any section.
         ...
         "[image_pack][view]")
{
    ...
    // Remove tile 0 ("a") — tile 1 shifts down to index 0; editing_ should
