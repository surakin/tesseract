...
TEST_CASE("make_row_data maps failed recoverable to PendingState::Failed with error",
          "[ui][pending]") {
    tesseract::TextEvent ev;
    ev.event_id          = "$txn2";
    ev.sender            = "@alice:example.org";
...
TEST_CASE("make_row_data maps failed unrecoverable to PendingState::Failed recoverable=false",
          "[ui][pending]") {
    tesseract::TextEvent ev;
    ev.event_id          = "$txn3";
    ev.sender            = "@alice:example.org";
