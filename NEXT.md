...
Reaction/reply buttons on hover over messages (reaction done)
...
Fix the typing notification position

The composer's text input text is not vertically aligned to its parent
