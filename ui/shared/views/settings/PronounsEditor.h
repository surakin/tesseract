...
public:
    ...
    // Fired after a definite edit (language picked, summary submitted, or a
    // row removed) with the subset of entries that have both a language and
    // a summary — never includes an in-progress empty row.
