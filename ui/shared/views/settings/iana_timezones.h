...
// Static table of canonical IANA tzdb zone identifiers, backing
// TimezonePicker's searchable dropdown for the account settings Timezone
// field (us.cloke.msc4175.tz). Zone IDs are data values, like this app's
...
//
// Generated from this system's /usr/share/zoneinfo/zone1970.tab (IANA's
// own canonical "primary zones" list), column 3, deduped and sorted.
// zone1970.tab already excludes deprecated backward-compatibility aliases
// (e.g. US/Eastern, Asia/Calcutta). 312 entries as of the tzdata
// version this was generated from.
...
inline constexpr IanaTimezone kIanaTimezones[] = {
    {"Africa/Abidjan"}, {"Africa/Algiers"}, {"Africa/Bissau"},
    {"Africa/Cairo"}, {"Africa/Casablanca"}, {"Africa/Ceuta"},
    {"Africa/El_Aaiun"}, {"Africa/Johannesburg"}, {"Africa/Juba"},
    ...
    {"America/Belize"}, {"America/Boa_Vista"}, {"America/Bogota"},
    ...
    {"America/Costa_Rica"}, {"America/Coyhaique"}, {"America/Cuiaba"},
    ...
    {"America/Grand_Turk"}, {"America/Guatemala"}, {"America/Guayaquil"},
    ...
    {"America/Phoenix"}, {"America/Port-au-Prince"}, {"America/Porto_Velho"},
    ...
    {"Asia/Kolkata"}, {"Asia/Krasnoyarsk"}, {"Asia/Kuching"},
    {"Asia/Macau"}, {"Asia/Magadan"}, {"Asia/Makassar"},
    {"Asia/Manila"}, {"Asia/Nicosia"}, {"Asia/Novokuznetsk"},
    ...
    {"Australia/Sydney"}, {"Europe/Andorra"}, {"Europe/Astrakhan"},
    {"Europe/Athens"}, {"Europe/Belgrade"}, {"Europe/Berlin"},
    {"Europe/Brussels"}, {"Europe/Bucharest"}, {"Europe/Budapest"},
    {"Europe/Chisinau"}, {"Europe/Dublin"}, {"Europe/Gibraltar"},
    {"Europe/Helsinki"}, {"Europe/Istanbul"}, {"Europe/Kaliningrad"},
    {"Europe/Kirov"}, {"Europe/Kyiv"}, {"Europe/Lisbon"},
    {"Europe/London"}, {"Europe/Madrid"}, {"Europe/Malta"},
    {"Europe/Minsk"}, {"Europe/Moscow"}, {"Europe/Paris"},
    {"Europe/Prague"}, {"Europe/Riga"}, {"Europe/Rome"},
    {"Europe/Samara"}, {"Europe/Saratov"}, {"Europe/Simferopol"},
    {"Europe/Sofia"}, {"Europe/Tallinn"}, {"Europe/Tirane"},
    {"Europe/Ulyanovsk"}, {"Europe/Vienna"}, {"Europe/Vilnius"},
    {"Europe/Volgograd"}, {"Europe/Warsaw"}, {"Europe/Zurich"},
    ...
    {"Pacific/Fakaofo"}, {"Pacific/Fiji"}, {"Pacific/Galapagos"},
    {"Pacific/Gambier"}, {"Pacific/Guadalcanal"}, {"Pacific/Guam"},
    {"Pacific/Honolulu"}, {"Pacific/Kanton"}, {"Pacific/Kiritimati"},
    {"Pacific/Kosrae"}, {"Pacific/Kwajalein"}, {"Pacific/Marquesas"},
