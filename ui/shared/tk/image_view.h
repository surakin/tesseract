...
public:
    ...
    ImageView& set_mode(ContentMode m)
    {
        mode_ = m;
        return *this;
    }
    ImageView& set_size(Size s)
    {
        explicit_size_ = s;
        return *this;
    }
...
public:
    ...
    Avatar& set_display_name(std::string n)
    {
        display_name_ = std::move(n);
        return *this;
    }
    Avatar& set_diameter(float d)
    {
        diameter_ = d;
        return *this;
    }
    Avatar& set_initials_bg(std::optional<Color> c)
    {
        initials_bg_ = c;
        return *this;
    }
    Avatar& set_initials_fg(std::optional<Color> c)
    {
        initials_fg_ = c;
        return *this;
    }
