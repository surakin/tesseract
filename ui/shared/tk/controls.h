...
private:
    void invalidate_cache() { cached_.reset(); cached_max_w_ = -2; }
...
public:
    ...
    Separator& set_thickness(float t)                 { thickness_ = t; return *this; }
    Separator& set_colour   (std::optional<Color> c)  { colour_    = c; return *this; }
...
public:
    enum class Variant { Primary, Subtle, Icon };
    ...
    Button& set_label    (std::string l) { label_   = std::move(l); invalidate_cache(); return *this; }
    Button& set_on_click (std::function<void()> f) { on_click_ = std::move(f); return *this; }
    Button& set_variant  (Variant v) { variant_ = v; return *this; }
    Button& set_enabled  (bool e)    { enabled_ = e; return *this; }
    Button& set_min_size (Size s)    { min_size_ = s; return *this; }
...
private:
    void invalidate_cache() { cached_.reset(); }
