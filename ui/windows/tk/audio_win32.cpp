...
public:
    ...
    HRESULT STDMETHODCALLTYPE EventNotify(DWORD event, DWORD_PTR /*param1*/,
...
private:
    ...
    void start_timer()
    {
        ...
        BOOL ok = CreateTimerQueueTimer(&timer_,
...
//  Factory
// ─────────────────────────────────────────────────────────────────────────
std::unique_ptr<tk::AudioPlayer> make_audio_player_win32(PostFn post)
{
